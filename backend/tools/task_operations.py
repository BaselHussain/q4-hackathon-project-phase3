"""
Core task operations used by both MCP tools and AI Agent function tools.

This module contains the actual business logic for task management.
Both the MCP server tools and OpenAI Agent function tools wrap these operations.
"""
